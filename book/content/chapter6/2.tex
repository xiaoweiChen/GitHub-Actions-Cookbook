...
\myGraphic{0.6}{content/chapter6/images/1.png}{图6.1 ---  将 GitHub Action 工作流程作业添加为受保护分支的状态检查}
...
\myGraphic{0.6}{content/chapter6/images/2.png}{图6.2 ---  在规则集中将 GitHub Action 工作流程作业添加为状态检查}
