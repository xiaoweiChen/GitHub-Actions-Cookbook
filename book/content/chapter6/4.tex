...
\myGraphic{0.4}{content/chapter6/images/4.png}{图6.4 --- CI 工作流程的徽章}
...
\myGraphic{0.4}{content/chapter6/images/5.png}{图6.5 --- 在工作流程摘要中显示代码覆盖率结果}

摘要也被添加为拉取请求的评论（见图 6.6）：

\myGraphic{0.4}{content/chapter6/images/6.png}{图6.6 --- 将代码覆盖率结果添加为拉取请求评论}
...
\myGraphic{0.4}{content/chapter6/images/7.png}{图6.7 --- 检查 Pages 网站}
...
\myGraphic{0.4}{content/chapter6/images/8.png}{图6.8 --- 添加测试覆盖率徽章}
...
\myGraphic{0.4}{content/chapter6/images/9.png}{图6.9 --- 在您的 GitHub README 中使用 SonarCloud 徽章}

Sonar 徽章提供了与您的拉取请求的出色集成，并且可以作为规则集和分支保护规则中的附加状态检查。质量门在拉取请求中报告（见图 6.10）：

\myGraphic{0.4}{content/chapter6/images/10.png}{图6.10 --- SonarCloud 质量门在拉取请求中的集成}
