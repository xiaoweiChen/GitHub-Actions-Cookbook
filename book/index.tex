...
\myChapter{第1章}{GitHub Actions Workflows}{content/chapter1/0.tex}
\mySubsection{1.1.}{Technical requirements}{content/chapter1/1.tex}
\mySubsection{1.2.}{The GitHub ecosystem}{content/chapter1/2.tex}
\mySubsection{1.3.}{Hosting and pricing for GitHub}{content/chapter1/3.tex}
\mySubsection{1.4.}{Pricing for GitHub Actions}{content/chapter1/4.tex}
\mySubsection{1.5.}{GitHub Marketplace}{content/chapter1/5.tex}
\mySubsection{1.6.}{Using the workflow editor for writing workflows}{content/chapter1/6.tex}
\mySubsection{1.7.}{Using secrets and variables}{content/chapter1/7.tex}
\mySubsection{1.8.}{Creating and using environments}{content/chapter1/8.tex}
\newpage

\myChapter{第2章}{Authoring and Debugging Workflows}{content/chapter2/0.tex}
\mySubsection{2.1.}{Using Visual Studio Code for authoring workflows}{content/chapter2/1.tex}
\mySubsection{2.2.}{Developing workflows in branches}{content/chapter2/2.tex}
\mySubsection{2.3.}{Linting workflows}{content/chapter2/3.tex}
\mySubsection{2.4.}{Writing messages to the log}{content/chapter2/4.tex}
\mySubsection{2.5.}{Enabling debug logging}{content/chapter2/5.tex}
\mySubsection{2.6.}{Running your workflows locally}{content/chapter2/6.tex}
\newpage
